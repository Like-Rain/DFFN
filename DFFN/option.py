...
parser = argparse.ArgumentParser(description='DFFN')
...
parser.add_argument('--dir_data_train', type=str, default='./dataset/div2k',
                    help='dataset directory')
parser.add_argument('--dir_data_test', type=str, default='./dataset/benchmark',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='DIV2K',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='Set5+Set14+B100+Urban100+Manga109',
...
parser.add_argument('--model', default='DFFN',
                    help='model name')
...
parser.add_argument('--begin_test_epoch', type=int, default=1,
                    help='number of epochs to begin test')
parser.add_argument('--load_epoch', type=int, default=0,
                    help='number of epochs to load train')
parser.add_argument('--switch_sgd_epoch', type=int, default=1201,
                    help='after number of epochs to swtich sgd')
