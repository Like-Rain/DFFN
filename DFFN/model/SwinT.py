...
class SwinT(nn.Module):
    def __init__(
            ...
            self,  depth = 2, n_feats = 50, num_heads = 5, drop_rate=0.):
...
class BasicLayer(nn.Module):
    def __init__(self, dim, resolution, embed_dim=50, depth=2, num_heads=8, window_size=8, drop_rate=0.,
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, resolution, num_heads, window_size=8, shift_size=0, drop_rate=0.,
...
if __name__ == '__main__':
    ...
    model = SwinTransformerBlock(48, 64, num_heads = 8, drop_rate=0.1, mlp_ratio = 2.0)
    model = model.to(device)
    # summary(model,(48,64,64),batch_size=1,device="cuda")
    summary(model,(1,48,64,64),device="cuda")
