...
# python ./src/main.py --model LbNet --scale 4 --pre_train C:\Project\gitProject\LBNet\test_model\LBNet\LBNet-X4.pt --test_only --rgb_range 255 --n_feats 32 --save_results
...
if __name__ == '__main__':
    ...
    # print(model)
    summary(model,(16,3,64,64),device="cpu")  #torchinfo
